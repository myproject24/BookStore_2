                                ...
                                <table class="table_div">
                                    ...
                                    <tr>
                                        <td class="table_row" style="color: #009900; font-weight: bold">
                                            ...
                                            <asp:Label ID="lbl2" runat="server" Text='%#Eval("Authorname") %>'></asp:Label>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td class="table_rowleft">
                                            <asp:LinkButton ID="LinkButton2" runat="server"
                                                Font-Underline="False" Style="font-weight: 700; color: Black" CommandName="ViewDetails" CommandArgument='%#Eval("ProductId") %>' BackColor="#FF9933">Read Online</asp:LinkButton>
                                        </td>
                                        <td class="table_rowright">
                                            <asp:LinkButton ID="LinkButton1" runat="server"
                                                Font-Underline="False" Style="font-weight: 700; color: Black" CommandName="ViewDetails" CommandArgument='%#Eval("ProductId") %>' BackColor="#FF9933">Buy Now</asp:LinkButton>
                                        </td>
                                    </tr>
                                </table>
                            </asp:Panel>
